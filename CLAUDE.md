...
As of 2026-04-25, `npm run lint` reports 8 errors that predate this work:
- `src/components/modelo149/Modelo149Form.jsx` — 5 × `react-hooks/static-components` (the same focus-loss bug — see "React focus bug" below)
